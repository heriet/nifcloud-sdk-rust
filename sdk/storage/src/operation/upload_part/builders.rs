...
impl UploadPartFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::upload_part::UploadPartOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::upload_part::UploadPartError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::upload_part::UploadPartOutput, crate::operation::upload_part::UploadPartError, Self> {
