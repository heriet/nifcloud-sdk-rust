...
fn uri_query(_input: &crate::operation::put_bucket_lifecycle_configuration::PutBucketLifecycleConfigurationInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    query.push_v("lifecycle");
    query.push_kv("x-id", "PutBucketLifecycleConfiguration");
    ::std::result::Result::Ok(())
}
