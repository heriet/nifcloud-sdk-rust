...
/// Orchestration and serialization glue logic for `PutObjectCopy`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct PutObjectCopy;
impl PutObjectCopy {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_object_copy::PutObjectCopyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_object_copy::PutObjectCopyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_object_copy::PutObjectCopyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_object_copy::PutObjectCopyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutObjectCopy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutObjectCopy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutObjectCopyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutObjectCopyResponseDeserializer));
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutObjectCopy")
...
.with_interceptor(PutObjectCopyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_object_copy::PutObjectCopyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_object_copy::PutObjectCopyError>::new());
...
#[derive(Debug)]
            struct PutObjectCopyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutObjectCopyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_object_copy::de_put_object_copy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_put_object_copy::de_put_object_copy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PutObjectCopyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutObjectCopyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_object_copy::PutObjectCopyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_object_copy::PutObjectCopyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::put_object_copy::PutObjectCopyInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    query.push_kv("x-id", "PutObjectCopy");
    ::std::result::Result::Ok(())
}
...
fn update_http_builder(
    ...
    let builder = crate::protocol_serde::shape_put_object_copy::ser_put_object_copy_headers(input, builder)?;
...
#[derive(Debug)]
            struct PutObjectCopyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutObjectCopyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutObjectCopyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutObjectCopyInput>()
                        .ok_or("failed to downcast to PutObjectCopyInput")?;
...
/// Error type for the `PutObjectCopyError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum PutObjectCopyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutObjectCopyError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl PutObjectCopyError {
    /// Creates the `PutObjectCopyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutObjectCopyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for PutObjectCopyError {
...
impl ::std::fmt::Display for PutObjectCopyError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for PutObjectCopyError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PutObjectCopyError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutObjectCopyError {
...
pub use crate::operation::put_object_copy::_put_object_copy_output::PutObjectCopyOutput;

pub use crate::operation::put_object_copy::_put_object_copy_input::PutObjectCopyInput;

mod _put_object_copy_input;

mod _put_object_copy_output;
