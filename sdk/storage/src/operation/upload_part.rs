...
fn uri_query(_input: &crate::operation::upload_part::UploadPartInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if inner_3.is_empty() {
        return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("part_number", "cannot be empty or unset"));
    }
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_upload_part_input::ser_body_http_payload( input.body)?);
