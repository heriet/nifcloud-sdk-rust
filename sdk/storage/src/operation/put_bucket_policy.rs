...
fn uri_query(_input: &crate::operation::put_bucket_policy::PutBucketPolicyInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    query.push_v("policy");
    query.push_kv("x-id", "PutBucketPolicy");
    ::std::result::Result::Ok(())
}
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_bucket_policy_input::ser_policy_http_payload( input.policy)?);
