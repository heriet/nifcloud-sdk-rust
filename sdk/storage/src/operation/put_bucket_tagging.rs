...
fn uri_query(_input: &crate::operation::put_bucket_tagging::PutBucketTaggingInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    query.push_v("tagging");
    query.push_kv("x-id", "PutBucketTagging");
    ::std::result::Result::Ok(())
}
