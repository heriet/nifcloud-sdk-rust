...
/// Orchestration and serialization glue logic for `PutBucket`.
...
impl PutBucket {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::put_bucket::PutBucketInput,
                    ) -> ::std::result::Result<crate::operation::put_bucket::PutBucketOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_bucket::PutBucketError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_bucket::PutBucketError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_bucket::PutBucketOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutBucket {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutBucket");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutBucketRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutBucketResponseDeserializer));
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutBucket")
...
.with_interceptor(PutBucketEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_bucket::PutBucketError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_bucket::PutBucketError>::new());
...
#[derive(Debug)]
            struct PutBucketResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutBucketResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_bucket::de_put_bucket_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_put_bucket::de_put_bucket_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PutBucketRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutBucketRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_bucket::PutBucketInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_bucket::PutBucketInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::put_bucket::PutBucketInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    query.push_kv("x-id", "PutBucket");
    ::std::result::Result::Ok(())
}
...
#[derive(Debug)]
            struct PutBucketEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutBucketEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutBucketEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutBucketInput>()
                        .ok_or("failed to downcast to PutBucketInput")?;
...
/// Error type for the `PutBucketError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum PutBucketError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutBucketError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl PutBucketError {
    /// Creates the `PutBucketError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutBucketError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for PutBucketError {
...
impl ::std::fmt::Display for PutBucketError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for PutBucketError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PutBucketError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutBucketError {
...
pub use crate::operation::put_bucket::_put_bucket_output::PutBucketOutput;

pub use crate::operation::put_bucket::_put_bucket_input::PutBucketInput;

mod _put_bucket_input;

mod _put_bucket_output;
