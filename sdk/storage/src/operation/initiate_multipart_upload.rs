...
impl InitiateMultipartUpload {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::initiate_multipart_upload::InitiateMultipartUploadOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::initiate_multipart_upload::InitiateMultipartUploadError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::initiate_multipart_upload::InitiateMultipartUploadError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::initiate_multipart_upload::InitiateMultipartUploadOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InitiateMultipartUpload {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("InitiateMultipartUpload");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(InitiateMultipartUploadRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(InitiateMultipartUploadResponseDeserializer));
...
.with_interceptor(InitiateMultipartUploadEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::initiate_multipart_upload::InitiateMultipartUploadError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::initiate_multipart_upload::InitiateMultipartUploadError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for InitiateMultipartUploadRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::initiate_multipart_upload::InitiateMultipartUploadInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::initiate_multipart_upload::InitiateMultipartUploadInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::initiate_multipart_upload::InitiateMultipartUploadInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    query.push_v("uploads");
    query.push_kv("x-id", "InitiateMultipartUpload");
    ::std::result::Result::Ok(())
}
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for InitiateMultipartUploadEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<InitiateMultipartUploadInput>()
                        .ok_or("failed to downcast to InitiateMultipartUploadInput")?;
...
pub enum InitiateMultipartUploadError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-InitiateMultipartUploadError) for what information is available for the error.")]
...
impl InitiateMultipartUploadError {
    /// Creates the `InitiateMultipartUploadError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `InitiateMultipartUploadError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for InitiateMultipartUploadError {
...
mod _initiate_multipart_upload_output;
