...
/// Configuration for a storage service client.
/// 
...
impl Builder {
    ...
    /// Sets the HTTP client to use when making requests.
                        ...
                        /// # fn example() {
                        /// use std::time::Duration;
                        /// use storage::config::{Builder, Config};
                        /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
                        ///
                        ...
                        /// }
                        ///
                        /// let mut builder = storage::Config::builder();
    ...
    /// Sets the endpoint resolver to use when making requests.
                            ...
                            /// ```no_run
                            /// use storage::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
                            /// #[derive(Debug)]
                            ...
                            /// let config = storage::Config::builder().endpoint_resolver(resolver).build();
    ...
    /// Set the retry_config for the builder
                            ...
                            /// ```no_run
                            /// use storage::config::Config;
                            /// use storage::config::retry::RetryConfig;
                            ///
    ...
    /// Set the sleep_impl for the builder
                            ...
                            ///
                            /// ```no_run
                            /// use storage::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
                            ///
                            /// #[derive(Debug)]
                            ...
                            ///
                            /// ```no_run
                            /// use storage::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
                            ///
                            /// #[derive(Debug)]
                            /// pub struct ForeverSleep;
                            ///
    ...
    /// Set the timeout_config for the builder
                            ...
                            /// # use std::time::Duration;
                            /// use storage::config::Config;
                            /// use storage::config::timeout::TimeoutConfig;
                            ///
    ...
    /// Set the identity cache for auth.
                        ...
                        /// ```no_run
                        /// use storage::config::IdentityCache;
                        ///
    ...
    /// Sets the [`behavior major version`](crate::config::BehaviorVersion).
                ...
                /// ```no_run
                /// use storage::config::BehaviorVersion;
                ///
                /// let config = storage::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone()).with_name("storage::config::Config").freeze(),
                                    cloneable: layer,
                ...
                pub(crate) fn new(
                    ...
                    Self {
                        config: ::aws_smithy_types::config_bag::Layer::from(layer)
                            .with_name("storage::config::ConfigOverrideRuntimePlugin").freeze(),
                        components,
                    }
                }
            }
                ...
                let mut plugins = ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins::new()
                    ...
                    .with_client_plugins(::aws_smithy_runtime::client::defaults::default_plugins(
                        ::aws_smithy_runtime::client::defaults::DefaultPluginParams::new()
                            .with_retry_partition_name("storage")
